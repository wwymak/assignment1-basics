...
from cs336_basics.model import Linear, Embedding, RMSNorm, silu, SwiGlu, RotaryPositionalEmbedding, softmax
...
def run_linear(
    ...
    linear.load_state_dict({"W": weights}, strict=False)
...
def run_embedding(
    ...
    embedding.load_state_dict({"W": weights}, strict=False)
